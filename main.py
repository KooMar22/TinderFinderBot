...
class TinderFinderBot():
    ...
    def login(self):
        ...
        cookie_reject_btn = self.driver.find_element(
            by=By.XPATH, value='//*[@id="c-1445344539"]/div/div[2]/div/div/div[1]/div[2]/button/div[2]/div[2]')
        ...
        fb_login = self.driver.find_element(
            by=By.XPATH, value='//*[@id="c1121241681"]/main/div/div/div[1]/div/div/div[2]/div[2]/span/div[2]/button/div[2]/div[2]/div/div')
        fb_login.click()
    ...
    def manage_swipes(self):
        ...
        allow_location_btn = self.driver.find_element(
            by=By.XPATH, value='//*[@id="c1121241681"]/main/div/div/div/div[3]/button[1]/div[2]/div[2]')
        allow_location_btn.click()

        # Disallow notifications
        notifications_btn = self.driver.find_element(
            by=By.XPATH, value='//*[@id="c1121241681"]/main/div/div/div/div[3]/button[2]/div[2]/div[2]')
